...
contract KaizenNFT is ERC721URIStorage {
    ...
    constructor() ERC721("KaizenNFT", "KNFT") {
        collectionName = name();
    ...
    function createKaizenNFT() public returns(uint256) {
        ...
        string memory json = Base64.encode(
            bytes(
                string(
                    ...
                    '{"name": "',
                        combinedWord,
                        '", "description": "A highly acclaimed collection Kaizen Warriors", "image": "data:image/svg+xml;base64,',
